...
if __name__ == '__main__':
    ...
    if ARGS.mode == 'train':
        ...
        print(
            f'Invalid mode: {ARGS.mode}! Must be either "train" or "predict".')
